...
a persistence unit "cooperativaUnionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "cooperativaUnion\pom.xml":
...
artifact ("cooperativaUnion.war") is already built. You can build
